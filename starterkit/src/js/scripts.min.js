...
!function(){"use strict";for(var e,t=function(){},o=["assert","clear","count","debug","dir","dirxml","error","exception","group","groupCollapsed","groupEnd","info","log","markTimeline","profile","profileEnd","table","time","timeEnd","timeStamp","trace","warn"],n=o.length,i=window.console=window.console||{};n--;)e=o[n],i[e]||(i[e]=t)}(),function(){$.scrollPage=null,$(document).ready(function(){$.scrollPage=$("html, body"),$("html, body").each(function(){$(this).scrollTop();return null!==$(this).scrollTop?($.scrollPage=$(this.nodeName.toLowerCase()),!1):void 0})}),$.getDocHeight=function(){return Math.max($(document).height(),$(window).height(),document.documentElement.clientHeight)},$.cookie=function(e,t,o,n){var i;n=void 0===n?"":" domain="+n,i="",void 0!==o&&0!==o&&(i=new Date,i.setTime(i.getTime()+24*o*60*60*1e3),i.toGMTString()),document.cookie=e+"="+t+"; expires="+i+";  path=/;"+n},$.getCookie=function(e){var t,o,n,i=document.cookie.split(";");for(e+="=",o=i.length,i[0]=" "+i[0],t=0;o>t;t+=1)for(n=i[t];" "===n.charAt(0);)if(n=n.substring(1,n.length),0===n.indexOf(e))return n.substr(e.length,n.length);return null},$.clearCookie=function(e,t){void 0===t?this.cookie(e,"",-1):this.cookie(e,"",-1,t)}}(jQuery);var WebFontConfig={custom:{families:["Sketchy","Sketchy Bold"],urls:["assets/css/styles.css"]}};!function(){var e=document.createElement("script");e.src=("https:"===document.location.protocol?"https":"http")+"://ajax.googleapis.com/ajax/libs/webfont/1.4.7/webfont.js",e.type="text/javascript",e.async="true";var t=document.getElementsByTagName("script")[0];t.parentNode.insertBefore(e,t)}();
!function(){"use strict";void 0===window.App&&(window.App=function(){}),window.App.CustomEvents=function(){this.list=null},window.App.CustomEvents.prototype.init=function(){this.list={}},window.App.CustomEvents.prototype.addTo=function(t,i){void 0===this.list[t]&&(this.list[t]=[]),this.list[t].push(i)},window.App.CustomEvents.prototype.doEvent=function(t,i){var o,n,s;if(void 0!==this.list[t]){for(n=this.list[t].slice(0),s=n.length,o=0;s>o;o+=1)"function"==typeof n[o]&&n[o](i);n=null}},window.App.CustomEvents.prototype.removeFrom=function(t,i){var o,n,s;if(void 0!==this.list[t])for(n=this.list[t],s=n.length,o=s-1;o>=0;o-=1)if(n[o]===i){n.splice(o,1);break}}}();
!function(){"use strict";void 0===window.App&&(window.App=function(){}),window.App.Resize=function(){this.timer=null,this.ie=!1,this.dim=null,this.resizeList=null},window.App.Resize.prototype.init=function(){this.ie=$("html").hasClass("lt-ie9"),this.dim={w:0,h:0},this.resizeList=[];var i=this.doResize,t=this.startTimer;$(window).resize($.proxy(this.ie?t:i,this)),window.main.customEvents.addTo("ADD_TO_RESIZE",$.proxy(this.addTo,this)),window.main.customEvents.addTo("REMOVE_FROM_RESIZE",$.proxy(this.removeFrom,this))},window.App.Resize.prototype.doResize=function(){var i,t=this.resizeList.length;for(i=0;t>i;i++)this.resizeList[i]()},window.App.Resize.prototype.clearTimer=function(){clearTimeout(this.timer),this.timer=null},window.App.Resize.prototype.startTimer=function(){(this.dim.w!==$(window).width()||this.dim.h!==$(window).height())&&(null!==this.timer&&this.clearTimer(),this.dim.w=$(window).width(),this.dim.h=$(window).height(),this.timer=setTimeout($.proxy(this.doResize,this),500))},window.App.Resize.prototype.addTo=function(i){this.resizeList.push(i)},window.App.Resize.prototype.removeFrom=function(i){var t,e=this.resizeList.length;for(t=e-1;t>=0;t--)if(this.resizeList[t]===i){this.resizeList.splice(t,1);break}}}();
!function(){"use strict";void 0===window.App&&(window.App=function(){}),window.App.ViewportOrientation=function(t){this.j=t,this.dw="device-width",this.dh="device-height"},window.App.ViewportOrientation.prototype.init=function(){return this.j.is("meta")&&"viewport"===this.j.attr("name")?(void 0!==window.orientation&&($(window).on("orientationchange",$.proxy(this.switchOrientation,this)),this.switchOrientation()),void 0):(window.main.customEvents.doEvent("log","ViewportOrientation j NOT meta!"),void 0)},window.App.ViewportOrientation.prototype.switchOrientation=function(){var t,i,n=window.orientation;90===Math.abs(n)?(t=this.dh,i=this.dw):(t=this.dw,i=this.dh),this.j.attr("content","width="+t+", height="+i+", initial-scale=1"),window.main.customEvents.doEvent("log","Orientation: "+n),$("#wrap").text("Orientation: "+n)}}();
!function(){"use strict";void 0===window.App&&(window.App=function(){}),window.App.WindowSize=function(){this.win=null,this.f=null},window.App.WindowSize.prototype.init=function(){this.win=$(window),window.main.customEvents.doEvent("log","WindowSize ready"),this.f=$.proxy(this.reportSize,this),window.main.customEvents.doEvent("ADD_TO_RESIZE",this.f)},window.App.WindowSize.prototype.reportSize=function(){window.main.customEvents.doEvent("log","WindowSize: width = "+this.win.width()+", height = "+this.win.height())}}();
!function(){"use strict";void 0===window.App&&(window.App=function(){}),window.App.DisplaySize=function(i){this.j=i,this.dpr=null,this.screenWidth=null,this.screenHeight=null,this.widthInches=null,this.heightInches=null,this.screenSize=null},window.App.DisplaySize.prototype.init=function(){var i,e,t,n,s,h,o,d,c,r,l,a,p,w;if(void 0===window.devicePixelRatio){for(window.main.customEvents.doEvent("log","typeof tested"),e=null,document.createStyleSheet?(i=document.createStyleSheet(""),e=""):i=$('<style type="text/css"></style>'),t=$('<div id="calcPixelRatio"></div>'),n=.25,s=1,h=10,o="#calcPixelRatio { position: absolute; font-size: 1px; }",d=h/n,window.main.customEvents.doEvent("log","vars ready"),c=s/n;d>=c;c+=1)r=c*n,o+="@media only screen and (min-resolution: "+Math.floor(96*r)+"dpi) { #calcPixelRatio { font-size: "+r+"px; } }\n";window.main.customEvents.doEvent("log","looped"),null!==e?i.cssText=o:(i.text(o),$("head").append(i)),window.main.customEvents.doEvent("log","head"),$("body").append(t),r=$("#calcPixelRatio").css("font-size"),window.main.customEvents.doEvent("log","#calcPixelRatio = "+r),this.dpr=r.substr(0,r.indexOf("px"))}else this.dpr=window.devicePixelRatio;if(l=0,p=0,a=0,w=0,void 0!==screen.width&&(l=screen.width,p=screen.height),window.main.customEvents.doEvent("log","Screen width: "+l+", height: "+p),window.matchMedia){var v=[8192,7680,6400,5120,4800,4608,4320,4096,3840,3200,3072,2880,2800,2560,2400,2304,2160,2100,2048,1920,1856,1800,1792,1728,1700,1680,1600,1536,1440,1400,1392,1366,1344,1280,1200,1152,1136,1120,1080,1050,1024,960,900,864,854,832,800,768,720,640,624,600,576,560,540,512,500,480,432,400,384,376,364,360,352,350,348,342,320,300,280,272,270,256,250,240,234,224,220,208,200,192,176,168,160,152,150,144,128,102,96,84,75,72,65,64,60,48,42,40,32,30,16,11];d=v.length;var u=function(i){for(c=0;d>c;c+=1)if(r=v[c],window.matchMedia("(device-"+i+": "+r+"px)").matches)return r;return 0};a=u("width"),w=u("height")}window.main.customEvents.doEvent("log","Device width: "+a+", height: "+w),this.dpr>1?((l===a||a===l*this.dpr)&&(l*=this.dpr,p*=this.dpr),this.widthInches=l/(96*this.dpr),this.heightInches=p/(96*this.dpr)):(this.widthInches=l/96,this.heightInches=p/96),this.screenSize=Math.sqrt(this.widthInches*this.widthInches+this.heightInches*this.heightInches),window.main.customEvents.doEvent("log","Reported size: "+this.screenSize+'"'),this.j.append("<p>DPR: "+this.dpr+"<br />Screen: "+l+" x "+p+"<br />Device: "+a+" x "+w+"<br />Est inches: "+this.widthInches+", "+this.heightInches+"<br />Reported size: "+this.screenSize+"&quot;</p>");var g=$('<div style="width: 1in; height: 1in; background: #999;"></div>');this.j.append(g),r=g.width(),this.j.append("<p>One inch = <strong>"+r+"</strong></p>")}}();
!function(){"use strict";void 0===window.App&&(window.App=function(){}),window.main=null,window.App.prototype.customEvents=null,window.App.prototype.init=function(){this.scan()},window.App.prototype.scan=function(n){void 0===n&&(n=$(document)),n.find("*[data-behavior]").each(function(){var n=$(this),i=n.attr("data-behavior");$.each(i.split(" "),function(i,o){if(void 0!==window.App[o]){var t=new window.App[o](n);t.init()}else window.main.customEvents.doEvent("log",'data-behavior: "'+o+'" not recognised!')}),n.removeAttr("data-behavior")})},$(document).ready(function(){window.main=new window.App,window.main.customEvents=new window.App.CustomEvents,window.main.resize=new window.App.Resize,window.main.customEvents.init();var n=function(n){console&&console.log(n)};window.main.customEvents.addTo("log",n),window.main.resize.init(),window.main.init()})}();