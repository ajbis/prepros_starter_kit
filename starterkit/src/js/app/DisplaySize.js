...
(function () {
    ...
    window.App.DisplaySize.prototype.init = function () {
        var styles, css, temp, inc, min, max, str, n, i, c, w, w2, h, h2;
        ...
        if (window.devicePixelRatio === undefined) {
            ...
            temp = $('<div id="calcPixelRatio"></div>');
            inc = 0.25;
            min = 1;
            max = 10;
            str = '#calcPixelRatio { position: absolute; font-size: 1px; }';
            n = max / inc;

            window.main.customEvents.doEvent('log', 'vars ready');

            for (i = min / inc; i <= n; i += 1) {
                c = i * inc;
        ...
        this.screenSize = Math.sqrt(this.widthInches * this.widthInches + this.heightInches * this.heightInches);
