...
!function(){for(var e,t=function(){},o=["assert","clear","count","debug","dir","dirxml","error","exception","group","groupCollapsed","groupEnd","info","log","markTimeline","profile","profileEnd","table","time","timeEnd","timeStamp","trace","warn"],n=o.length,i=window.console=window.console||{};n--;)e=o[n],i[e]||(i[e]=t)}(),function(){$.scrollPage=null,$(document).ready(function(){$.scrollPage=$("html, body"),$("html, body").each(function(){return $(this).scrollTop(),null!==$(this).scrollTop?($.scrollPage=$(this.nodeName.toLowerCase()),!1):void 0})}),$.getDocHeight=function(){return Math.max($(document).height(),$(window).height(),document.documentElement.clientHeight)},$.cookie=function(e,t,o,n){var i;n=void 0===n?"":" domain="+n,i="",void 0!==o&&0!==o&&(i=new Date,i.setTime(i.getTime()+1e3*60*60*24*o),i.toGMTString()),document.cookie=e+"="+t+"; expires="+i+";  path=/;"+n},$.getCookie=function(e){var t,o,n,i=document.cookie.split(";");for(e+="=",o=i.length,t=0;o>t;t+=1)for(n=i[t];" "===n.charAt(0);)if(n=n.substring(1,n.length),0===n.indexOf(e))return n.substr(e.length,n.length);return null},$.clearCookie=function(e,t){void 0===t?this.cookie(e,"",-1):this.cookie(e,"",-1,t)}}(jQuery),WebFontConfig={custom:{families:["Sketchy","Sketchy Bold"],urls:["assets/css/styles.css"]}},function(){var e=document.createElement("script");e.src=("https:"==document.location.protocol?"https":"http")+"://ajax.googleapis.com/ajax/libs/webfont/1.4.7/webfont.js",e.type="text/javascript",e.async="true";var t=document.getElementsByTagName("script")[0];t.parentNode.insertBefore(e,t)}();
!function(){"undefined"==typeof window.App&&(window.App=function(){}),window.App.CustomEvents=function(){},window.App.CustomEvents.prototype.init=function(){this.list={}},window.App.CustomEvents.prototype.addTo=function(t,i){"undefined"==typeof this.list[t]&&(this.list[t]=[]),this.list[t].push(i)},window.App.CustomEvents.prototype.doEvent=function(t,i){if("undefined"!=typeof this.list[t]){var n,o=this.list[t].slice(0),e=o.length;for(n=0;e>n;n++)"function"==typeof o[n]&&o[n](i);o=null}},window.App.CustomEvents.prototype.removeFrom=function(t,i){if("undefined"!=typeof this.list[t]){var n,o=this.list[t],e=o.length;for(n=e-1;n>=0;n--)if(o[n]===i){o.splice(n,1);break}}}}();
!function(){"undefined"==typeof window.App&&(window.App=function(){}),window.App.Resize=function(){},window.App.Resize.prototype.timer,window.App.Resize.prototype.ie,window.App.Resize.prototype.dim,window.App.Resize.prototype.resizeList,window.App.Resize.prototype.init=function(){this.ie=$("html").hasClass("lt-ie9"),this.dim={w:0,h:0},this.resizeList=[];var i=this.doResize,e=this.startTimer;$(window).resize($.proxy(this.ie?e:i,this)),window.main.customEvents.addTo("ADD_TO_RESIZE",$.proxy(this.addTo,this)),window.main.customEvents.addTo("REMOVE_FROM_RESIZE",$.proxy(this.removeFrom,this))},window.App.Resize.prototype.doResize=function(){var i,e=this.resizeList.length;for(i=0;e>i;i++)this.resizeList[i]()},window.App.Resize.prototype.clearTimer=function(){clearTimeout(this.timer)},window.App.Resize.prototype.startTimer=function(){(this.dim.w!=$(window).width()||this.dim.h!=$(window).height())&&("undefined"!=typeof this.timer&&this.clearTimer(),this.dim.w=$(window).width(),this.dim.h=$(window).height(),this.timer=setTimeout($.proxy(this.doResize,this),500))},window.App.Resize.prototype.addTo=function(i){this.resizeList.push(i)},window.App.Resize.prototype.removeFrom=function(i){var e,t=this.resizeList.length;for(e=t-1;e>=0;e--)if(this.resizeList[e]===i){this.resizeList.splice(e,1);break}}}();
!function(){"undefined"==typeof window.App&&(window.App=function(){}),window.App.ViewportOrientation=function(t){this.j=t},window.App.ViewportOrientation.prototype.j,window.App.ViewportOrientation.prototype.dw="device-width",window.App.ViewportOrientation.prototype.dh="device-height",window.App.ViewportOrientation.prototype.init=function(){return this.j.is("meta")&&"viewport"===this.j.attr("name")?("undefined"!=typeof window.orientation&&($(window).on("orientationchange",$.proxy(this.switchOrientation,this)),this.switchOrientation()),void 0):(window.main.customEvents.doEvent("log","ViewportOrientation j NOT meta!"),void 0)},window.App.ViewportOrientation.prototype.switchOrientation=function(){var t,i,n=window.orientation;90===Math.abs(n)?(t=this.dh,i=this.dw):(t=this.dw,i=this.dh),this.j.attr("content","width="+t+", height="+i+", initial-scale=1"),window.main.customEvents.doEvent("log","Orientation: "+n),$("#wrap").text("Orientation: "+n)}}();
!function(){"undefined"==typeof window.App&&(window.App=function(){}),window.App.WindowSize=function(){},window.App.WindowSize.prototype.win,window.App.WindowSize.prototype.f,window.App.WindowSize.prototype.init=function(){this.win=$(window),window.main.customEvents.doEvent("log","WindowSize ready"),this.f=$.proxy(this.reportSize,this),window.main.customEvents.doEvent("ADD_TO_RESIZE",this.f)},window.App.WindowSize.prototype.reportSize=function(){window.main.customEvents.doEvent("log","WindowSize: width = "+this.win.width()+", height = "+this.win.height())}}();
!function(){"undefined"==typeof window.App&&(window.App=function(){}),window.App.DisplaySize=function(e){this.j=e},window.App.DisplaySize.prototype.j,window.App.DisplaySize.prototype.dpr,window.App.DisplaySize.prototype.screenWidth,window.App.DisplaySize.prototype.screenHeight,window.App.DisplaySize.prototype.widthInches,window.App.DisplaySize.prototype.heightInches,window.App.DisplaySize.prototype.screenSize,window.App.DisplaySize.prototype.init=function(){if("undefined"==typeof window.devicePixelRatio){window.main.customEvents.doEvent("log","typeof tested");var e,i;document.createStyleSheet?(e=document.createStyleSheet(""),i=""):e=$('<style type="text/css"></style>');var t,n,o=$('<div id="calcPixelRatio"></div>'),s=.25,d=1,h=10,p="#calcPixelRatio { position: absolute; font-size: 1px; }",c=h/s;for(window.main.customEvents.doEvent("log","vars ready"),t=d/s;c>=t;t++)n=t*s,p+="@media only screen and (min-resolution: "+Math.floor(96*n)+"dpi) { #calcPixelRatio { font-size: "+n+"px; } }\n";window.main.customEvents.doEvent("log","looped"),"undefined"!=typeof i?e.cssText=p:(e.text(p),$("head").append(e)),window.main.customEvents.doEvent("log","head"),$("body").append(o),n=$("#calcPixelRatio").css("font-size"),window.main.customEvents.doEvent("log","#calcPixelRatio = "+n),this.dpr=n.substr(0,n.indexOf("px"))}else this.dpr=window.devicePixelRatio;var r=0,w=0,a=0,l=0;if("undefined"!=typeof screen.width&&(r=screen.width,w=screen.height),window.main.customEvents.doEvent("log","Screen width: "+r+", height: "+w),window.matchMedia){var v=[8192,7680,6400,5120,4800,4608,4320,4096,3840,3200,3072,2880,2800,2560,2400,2304,2160,2100,2048,1920,1856,1800,1792,1728,1700,1680,1600,1536,1440,1400,1392,1366,1344,1280,1200,1152,1136,1120,1080,1050,1024,960,900,864,854,832,800,768,720,640,624,600,576,560,540,512,500,480,432,400,384,376,364,360,352,350,348,342,320,300,280,272,270,256,250,240,234,224,220,208,200,192,176,168,160,152,150,144,128,102,96,84,75,72,65,64,60,48,42,40,32,30,16,11];c=v.length;var y=function(e){for(t=0;c>t;t++)if(n=v[t],window.matchMedia("(device-"+e+": "+n+"px)").matches)return n;return 0};a=y("width"),l=y("height")}window.main.customEvents.doEvent("log","Device width: "+a+", height: "+l),this.dpr>1?((r===a||a===r*this.dpr)&&(r*=this.dpr,w*=this.dpr),this.widthInches=r/(96*this.dpr),this.heightInches=w/(96*this.dpr)):(this.widthInches=r/96,this.heightInches=w/96),this.screenSize=Math.sqrt(this.widthInches*this.widthInches+this.heightInches*this.heightInches),window.main.customEvents.doEvent("log","Reported size: "+this.screenSize+'"'),this.j.append("<p>DPR: "+this.dpr+"<br />Screen: "+r+" x "+w+"<br />Device: "+a+" x "+l+"<br />Est inches: "+this.widthInches+", "+this.heightInches+"<br />Reported size: "+this.screenSize+"&quot;</p>");var u=$('<div style="width: 1in; height: 1in; background: #999;"></div>');this.j.append(u),n=u.width(),this.j.append("<p>One inch = <strong>"+n+"</strong></p>")}}();
!function(){"undefined"==typeof window.App&&(window.App=function(){}),window.main,window.App.prototype.customEvents,window.App.prototype.init=function(){this.scan()},window.App.prototype.scan=function(n){void 0==n&&(n=$(document)),n.find("*[data-behavior]").each(function(){var n=$(this),i=n.attr("data-behavior");$.each(i.split(" "),function(i,o){if("undefined"!=typeof window.App[o]){var t=new window.App[o](n);t.init()}else window.main.customEvents.doEvent("log",'data-behavior: "'+o+'" not recognised!')}),n.removeAttr("data-behavior")})},$(document).ready(function(){window.main=new window.App,window.main.customEvents=new window.App.CustomEvents,window.main.resize=new window.App.Resize,window.main.customEvents.init();var n=function(n){console&&console.log(n)};window.main.customEvents.addTo("log",n),window.main.resize.init(),window.main.init()})}();